...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        label = np.load(os.path.join(image_folder, os.path.splitext(self.image_paths[index])[0] + '_gt.npy'))
        print(os.path.join(image_folder, os.path.splitext(self.image_paths[index])[0] + '_gt.npy'))
