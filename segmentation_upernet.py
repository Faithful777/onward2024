...
from mmcv.runner import load_checkpoint, BaseModule, auto_fp16
...
class ConvMAE(nn.Module):
    ...
    """
    def __init__(self, img_size=[224, 56, 28], patch_size=[4,2,2], in_chans=3, num_classes=80, embed_dim=[256,384,768], depth=[2,2,11],
